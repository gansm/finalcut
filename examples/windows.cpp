  ...
  : finalcut::FDialog{parent}
{
  ...
  left_arrow = arrow_up;
  left_arrow.setForegroundColor (wc_label.inactive_fg);
  left_arrow.setEmphasis();
  left_arrow.ignorePadding();

  right_arrow_1 = arrow_up;
  right_arrow_1.setForegroundColor (wc_label.inactive_fg);
  right_arrow_1.setEmphasis();
  right_arrow_1.ignorePadding();

  right_arrow_2 = arrow_up;
  right_arrow_2.setForegroundColor (wc_label.inactive_fg);
  ...
  bottom_label.setForegroundColor (wc_label.inactive_fg);

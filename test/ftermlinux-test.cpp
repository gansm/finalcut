...
void FTermLinuxTest::linuxCursorStyleTest()
{
  ...
  if ( isConEmuChildProcess(pid) )
  {
    ...
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?0c" );
    characters.clear();
    ...
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?1c" );
    characters.clear();
    linux.setCursorStyle (finalcut::LinuxConsoleCursorStyle::Underscore);
    CPPUNIT_ASSERT ( characters == CSI "?2c" );
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?2c" );
    ...
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?3c" );
    ...
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?4c" );
    ...
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?5c" );
    ...
    CPPUNIT_ASSERT_CSTRING ( linux.getCursorStyleCtrl().data, CSI "?6c" );
